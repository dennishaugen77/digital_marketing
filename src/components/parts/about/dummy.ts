export const specialistDetail = {
    title: 'Specialist in Digital Marketing Solutions',
    detail: [
    ...
    comment: 'Since the beginning rhoncus ut enim, elit amet nisl, tempor etiam eget vestibulum, amet, sem porttitor ultrices tristique quis metus fringilla etiam tellus sed sit vestibulum blandit.',
    name: 'George Best',
    avatar: "/images/digital-marketing-agency-executive-chariman-img.jpg",
