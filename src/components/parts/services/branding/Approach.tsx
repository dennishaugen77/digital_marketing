    ...
    <div className="bg-primary-light px-12 py-24">
      <div className="max-width divide- mx-auto flex w-full flex-col divide-y-2 divide-white/30">
        <div className="flex flex-col">
          <p className="text-xl text-white font-primary">Our Approach</p>
          <p className="text-title mt-2 font-medium text-white font-primary">
            Insight. Creativity. Technology.
          </p>
          <p className="px-[24%] py-8 text-lg text-white font-secondary">
          ...
          {approachList.map((el, index) => {
            return (
              <div key={index} className="flex flex-col items-center">
                ...
                <p className="text-2xl font-medium text-white font-primary">{el.title}</p>
                <p className="text-white font-secondary">{el.detail}</p>
              </div>
            )
          })}
        </div>
