  ...
  return (
    <div className="bg-background flex px-10 pt-24 pb-16">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col md:flex-row">
        <p className="text-primary-light mt-2 w-1/4 text-start font-semibold uppercase font-primary">
          What we do
        </p>
        <div className="flex-1">
          <div className="flex flex-col border-b-2 border-white">
            <p className="cxl:pr-[40%] lg:text-title mb-10 text-start text-4xl leading-17 font-semibold text-black font-primary">
