  ...
  return (
    <div className="bg-background relative flex bg-[url(./assets/images/digital-marketing-agency-arc-stroke-white-grad-2.svg)] bg-[length:50vw_auto] bg-left-bottom bg-no-repeat px-10 py-26 transition-all duration-300">
      ...
      <div className="relative mx-auto flex w-full max-w-[1200px] flex-col">
        ...
        <p className="lg:text-title mt-6 mb-2 text-center text-5xl font-semibold text-black">
          Take Your Business to the next Level
        </p>
        <p className="text-global-color2 cxl:px-60 clg:px-20 mb-16 text-center text-lg font-normal">
          ...
          {business.map((el, index) => {
            return (
              ...
              >
                ...
                <p className="mb-4 text-start text-2xl font-semibold text-black">
                  {el.title}
                </p>
                <p className="text-global-color2 text-start text-base leading-relaxed">
                  {el.content}
                </p>
              </div>
            )
