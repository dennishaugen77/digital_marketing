    ...
    <div className="relative flex w-full flex-col bg-[url(/images/digital-marketing-agency-hero-img-bg.jpg)] bg-cover bg-center">
      ...
      <div className="relative my-auto flex px-10">
        <div className="max-width mx-auto">
          <div className="clg:mr-[25%] lg:mt-50 mt-25  lg:mb-44 sm:mb-30 csm:!mb-15 mb-7 xl:mr-[40%]">
            <p className="clg:text-start font-semibold text-white uppercase">
              welcome to delectus
            </p>
            <p className="clg:text-start clg:leading-20 font-primary mt-8 text-5xl font-semibold text-white lg:text-6xl xl:text-[4.5rem] xl:leading-28">
            ...
            <div className="mt-15 flex flex-col items-center cxs:!flex-row">
              <div className="bg-primary w-full cursor-pointer rounded-lg px-5 py-3 text-[0.9rem] font-semibold text-white transition-colors duration-300 ease-in-out hover:bg-white hover:text-black cxs:w-auto">
                Get a Free Quote
              </div>
