  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="bg-background flex flex-col">
        <div className="mx-auto flex sm:flex-row flex-col w-full max-w-[1200px] px-10 py-24">
          <div className="w-1/6 md:w-1/4"></div>
          <div className="flex flex-1 flex-col">
            <p className="font-primary md:pr-[30%] text-start text-4xl font-medium text-black">
            ...
            <div className="mt-10 grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <p className="text-global-color2 font-secondary sm:pr-20 text-start">
