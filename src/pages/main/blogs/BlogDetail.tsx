  ...
  return (
    <div className="bg-background flex flex-col gap-6 py-16">
      <div className="max-width mx-auto w-full bg-white px-[6.67rem] py-[5.34rem]">
        ...
        <p className="text-title1 text-start font-primary">{currentDetail?.title}</p>
        <div className="text-title3 mb-5 flex gap-1">
          <p className="hover:text-primary cursor-pointer font-secondary">Leave a comment</p>
          <p className="">/</p>
        ...
        <p className="text-title3 text-global-color2 mb-4 text-start font-primary">
        ...
        <div className="mb-5 border-l-4 border-gray-100 px-4 py-6">
          <p className="text-title3 text-global-color2 text-start italic font-primary">
        ...
        <p className="text-title3 text-global-color2 text-start font-primary">
          {currentDetail?.describe5}
        </p>
      </div>
      <div className="max-width mx-auto flex w-full justify-between">
        <p className="flex items-center gap-0.5 font-primary">
      ...
      <div className="max-width mx-auto flex w-full flex-col justify-between bg-white px-[6.67rem] py-[5.34rem]">
        <p className="text-title1 mb-3 text-start font-primary">Leave a Comment</p>
        <p className="mb-5 text-start font-secondary">
          Your email address will not be published. Required fields are marked *
        </p>
        <textarea
          className="bg-gray-100 mb-5 border-1 border-gray-200 p-4 focus:outline-1 focus:outline-dotted"
          placeholder="Type here.."
        />
        <div className="mb-5 flex justify-between gap-8">
          <input
            placeholder="Name*"
            className="bg-gray-100 w-full border-1 border-gray-200 p-4 focus:outline-1 focus:outline-dotted font-secondary"
          />
          <input
            placeholder="Email*"
            className="bg-gray-100 w-full border-1 border-gray-200 p-4 focus:outline-1 focus:outline-dotted font-secondary"
        ...
        <div className="flex">
          <div className="bg-primary cursor-pointer px-6 py-3 text-white hover:bg-white hover:text-black font-secondary">
            Posts Comment »
          </div>
        </div>
      </div>
