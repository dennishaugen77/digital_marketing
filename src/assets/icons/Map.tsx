...
export const Map: React.FC<IconProps> = ({ color, className, style }) => (
  <svg
  ...
  >
   <g>
	<g>
		<path fill="currentColor" d="M146.667,0C94.903,0,52.946,41.957,52.946,93.721c0,22.322,7.849,42.789,20.891,58.878
		...
		<circle fill="currentColor" cx="146.667" cy="90.196" r="21.756"/>
	</g>
</g>
  </svg>
)